...
#! Warning! z-pulse is generated by the SquarePulse and it will modulate the pulse so the real z-pulse amplitude is in the following relation:
#? real_z_amp = 2.5*assigned_z_amp/sqrt(2) unit in Volt
