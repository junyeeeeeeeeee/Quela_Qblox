...
file = "Modularize/Meas_raw/20241102/DR2multiQ_T1(0)_H17M28S54.nc"
...
for var in ds.data_vars:
    if var.split("_")[-1] != 'x':
        ...
        for idx, data in enumerate(reshaped):
            ...
            ans = T1_fit_analysis(data,time_data)
            
            # if reshaped.shape[0] == 1:
            Fit_analysis_plot(ans,P_rescale=False,Dis=None)
            # else:
            #     T1_fit.append(ans.attrs["T1"])
