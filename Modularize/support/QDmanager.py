...
class QDmanager():
    ...
    def build_new_QD(self,qubit_number:int,Hcfg:dict,cluster_ip:str,dr_loc:str,chip_name:str=""):
        """
        ...
        self.Hcfg = Hcfg
        self.register(cluster_ip_adress=cluster_ip,which_dr=dr_loc,chip_name=chip_name)
