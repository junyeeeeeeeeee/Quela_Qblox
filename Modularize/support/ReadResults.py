...
from Modularize.support.Pulse_schedule_library import dataset_to_array, IQ_data_dis, T1_fit_analysis, Fit_analysis_plot


if __name__ == '__main__':
    import os
    
    QD_agent = QDmanager('Modularize/QD_backup/2024_8_23/DR4#81_SumInfo.pkl')
    QD_agent.QD_loader()
    qs = ['q0']
    # for q in qs:
    #     print(q,":")
    ...
    file = 'Modularize/Meas_raw/2024_8_23/DR4q0_T1(0)_H0M22S45.nc'
    ...
    data_fit= T1_fit_analysis(data=data,freeDu=array(nc.x0),T1_guess=10e-6)
