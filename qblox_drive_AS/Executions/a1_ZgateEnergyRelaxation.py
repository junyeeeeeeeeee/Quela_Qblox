...
z_amp_range:list = [-0.08, 0.08, 300]                # [start, end, pts/step], depends on bias_sampling_func you use
z_sampling_func:str = 'linspace'                     # 'linspace', 'arange'

time_monitor:bool = False                            # True will use while loop
...
EXP.WorkFlow()
EXP.RunAnalysis(time_dep_plot=time_monitor)