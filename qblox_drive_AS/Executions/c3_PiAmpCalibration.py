...
ro_power_coef_range:dict = {"q0":[0.9,1.1], "q1":[0.85,1.15]}
...
EXP.SetParameters(ro_power_coef_range,coef_sampling_func,coef_ptsORstep,pi_pair_num,avg_n=AVG,execution=Execution)
EXP.WorkFlow()
EXP.RunAnalysis()