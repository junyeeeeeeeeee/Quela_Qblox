...
half_pi_coef_range:dict = {"q4":[0.9,1.1]}    # half pi pulse coef, it should be around 1
...
EXP.SetParameters(half_pi_coef_range,coef_sampling_func,coef_ptsORstep,half_pi_quadruple_num,avg_n=AVG,execution=Execution)
EXP.WorkFlow()
EXP.RunAnalysis()