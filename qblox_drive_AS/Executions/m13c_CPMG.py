...
time_range:dict = {"q0":[0,20e-6],"q1":[0,15e-6]}
pi_num:dict = {"q0":2,"q1":3}
...
EXP.SetParameters(time_range,pi_num,time_sampling_func,time_ptsORstep,histo_counts,AVG,Execution)
EXP.WorkFlow()
