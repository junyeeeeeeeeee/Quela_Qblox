...
freq_span_range:dict = {"q0":[-350e6,100e6]}#, "q1":[-350e6,100e6]}    # [freq_span_start, freq_span_end] use linspace, total span should <= 500 MHz
bias_elements:list = ['q0', 'q1']
z_amp_range:list = [-0.08, 0.08, 20]                                 # z-pulse amplitude [from, end, pts/step]
