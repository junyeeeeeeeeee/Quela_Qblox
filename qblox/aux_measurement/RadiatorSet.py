...
from qblox.support.Path_Book import meas_raw_dir
from qblox.SOP.m13_T1  import T1_executor
from qblox.SOP.m12_T2  import ramsey_executor
...
def time_monitor(monitoring_info:dict, other_info:dict, qubit:str, data_parent_dir:str, start_time):
    from qblox.analysis.Radiator.RadiatorSetAna import a_set_analysis,live_time_monitoring_plot
