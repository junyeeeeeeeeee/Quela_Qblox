...
from qblox.support.FluxBiasDict import FluxBiasDict
from qblox.support.Notebook import Notebook
...
class Data_manager:
    ...
    def __init__(self):
        ...
        from qblox.support.Path_Book import qdevice_backup_dir
    ...
    def save_histo_pic(self,QD_agent:QDmanager,hist_dict:dict,qb:str='q0',mode:str="t1", show_fig:bool=False, save_fig:bool=True,pic_folder:str=''):
        from qblox.support.Pulse_schedule_library import hist_plot
